...
# BEGIN GENERATED BOOT CONSTANTS
  ...
  newCONSTSUB(stash, "LOG_ERROR", newSViv(LOG_ERROR));
  newCONSTSUB(stash, "LOG_INFO", newSViv(LOG_INFO));
  newCONSTSUB(stash, "LOG_DEBUG", newSViv(LOG_DEBUG));
  newCONSTSUB(stash, "READ_FLAG_NORMAL", newSViv(READ_FLAG_NORMAL));
  newCONSTSUB(stash, "READ_FLAG_BLOCKING", newSViv(READ_FLAG_BLOCKING));
  newCONSTSUB(stash, "READ_FLAG_FORCE_SYNC", newSViv(READ_FLAG_FORCE_SYNC));
  newCONSTSUB(stash, "READ_FLAG_SYNC", newSViv(READ_FLAG_SYNC));
  newCONSTSUB(stash, "GRAB_MODE_UNGRAB", newSViv(UNGRAB));
  newCONSTSUB(stash, "GRAB", newSViv(GRAB));
  newCONSTSUB(stash, "READ_STATUS_SUCCESS", newSViv(READ_STATUS_SUCCESS));
  newCONSTSUB(stash, "READ_STATUS_SYNC", newSViv(READ_STATUS_SYNC));
  newCONSTSUB(stash, "LED_ON", newSViv(LED_ON));
  newCONSTSUB(stash, "LED_OFF", newSViv(LED_OFF));
